...
<body>
  ...
  <div class="container">
    ...
    <!-- INÍCIO DO BLOCO DE GRÁFICOS SUBSTITUÍDO -->
   ...
   <div class="modal">
     ...
     <div class="modal-body">
       <form id="expenseForm">
         ...
         <div class="form-group checkbox-wrapper" id="expenseShowInCommitmentsGroup" style="display: none;">
           <input type="checkbox" class="checkbox" id="expenseShowInCommitments" checked>
           <label class="checkbox-label" for="expenseShowInCommitments">Mostrar em Compromissos Longos</label>
         </div>
